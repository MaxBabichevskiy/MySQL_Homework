...
go if db_id('Academy') is not null begin drop database [Academy];

end go create database [Academy];
...
INSERT INTO
    Faculties (Financing, Name)
VALUES (10000, 'Computer Science');

INSERT INTO
    Departments (Financing, Name, FacultyId)
VALUES (20000, 'Department1', 1);

INSERT INTO Groups (Name, Year, DepartmentId) VALUES ('P107', 5, 1);
...
WHERE
    ...
    AND Teachers.Surname = 'Samantha'
    AND Lectures.SubjectId = SubjectId;
...
SELECT
    Teachers.Name + Teachers.Surname AS 'Teachers Name'
FROM
    Teachers,
    Lectures,
    Subjects
