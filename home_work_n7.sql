...
go if db_id('Academy7') is not null begin drop database Academy7;

end go create database Academy7;
...
VALUES ('Edward', 'Hopper'), ('Alex', 'Carmack'), ('Pavel', 'Korolenko'), ('Vasya', 'Kvas');
...
INSERT INTO
    Faculties (Building, DeanId, Name)
...
VALUES (4, 1, 1, 'Software Development'), (2, 1, 1, 'Design');

INSERT INTO
    Groups (DepartmentId, Name, Year)
VALUES (1, 'F505', 2), (2, 'F507', 5), (1, 'F506', 3);

INSERT INTO Subjects (Name) VALUES ('Proggramming'), ('Design');

INSERT INTO
    Lectures (SubjectId, TeacherId)
VALUES (1, 1), (2, 2), (1, 3), (2, 4);

INSERT INTO
    LectureRooms (Building, Name)
VALUES (2, 'A311'), (3, 'A104');
...
INSERT INTO
    GroupsLectures (GroupId, LectureId)
VALUES (1, 1), (2, 2), (3, 3);
...
FROM
    ...
    Teachers
WHERE
    Schedules.LectureRoomId = LectureRooms.Id
    AND Schedules.LectureId = Lectures.Id
    AND Teachers.Name = 'Edward'
...
SELECT
    DISTINCT Schedules.DayOfWeek
FROM Schedules, LectureRooms
WHERE
    Schedules.LectureRoomId = LectureRooms.Id
    AND LectureRooms.Building = 6
    AND LectureRooms.Name = 'A311'
    AND LectureRooms.Name = 'A311';